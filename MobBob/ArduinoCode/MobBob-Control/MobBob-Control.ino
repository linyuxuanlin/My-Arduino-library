/*http://www.thingiverse.com/thing:715688/#comments
 * bob机器人
 * 
 * 
 * ======================================
...
int LeftHipIn(int millisecs)     { return LEFT_HIP_CENTRE + millisecs; }
int LeftHipOut(int millisecs)    { return LEFT_HIP_CENTRE - millisecs; }

int RightHipCentre()             { return RIGHT_HIP_CENTRE; }
int RightHipIn(int millisecs)    { return RIGHT_HIP_CENTRE - millisecs; }
int RightHipOut(int millisecs)   { return RIGHT_HIP_CENTRE + millisecs; }
