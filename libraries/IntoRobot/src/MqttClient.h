...
class MqttClientClass
{
    ...
    public:
        ...
        MqttClientClass(uint8_t *ip, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client);
        MqttClientClass(char* domain, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client);
        MqttClientClass(uint8_t *ip, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client, Stream& stream);
        MqttClientClass(char* domain, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client, Stream& stream);
