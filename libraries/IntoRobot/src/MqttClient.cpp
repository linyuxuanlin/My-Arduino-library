...
/*********************************************************************************
  ...
  *Others		:         
**********************************************************************************/
MqttClientClass::MqttClientClass(uint8_t *ip, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client) 
{
    this->_client = &client;
...
/*********************************************************************************
  ...
  *Others		:         
**********************************************************************************/
MqttClientClass::MqttClientClass(char* domain, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client) 
{
    this->_client = &client;
    this->callback = callback;
    this->domain = domain;
...
/*********************************************************************************
  ...
  *Others		:         
**********************************************************************************/
MqttClientClass::MqttClientClass(uint8_t *ip, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client, Stream& stream) 
{
    this->_client = &client;
    this->callback = callback;
    this->ip = ip;
...
/*********************************************************************************
  ...
  *Others		:         
**********************************************************************************/
MqttClientClass::MqttClientClass(char* domain, uint16_t port, void (*callback)(char*, uint8_t*, uint32_t), Client& client, Stream& stream)
{
    this->_client = &client;
    this->callback = callback;
    this->domain = domain;
